...
public class UserTest {
  ...
  public void testUpdateHspNewUser() {
    ...
    assertEquals(Arrays.toString(this.newUser.getCurrentSong().getPoint()),
        Arrays.toString(this.newUser.getHistoricalSongPoint()));
  }
  ...
  /**
   * Tests findConnections and findHistorical Connections on a user with previously loaded connections
   */
  @Test
