...
public class HandlersTest {
  ...
  public void integrationTest() throws IOException {
    ...
    URL requestLoadSongFeatures = new URL("http://localhost:" + Spark.port() + "/load-song-features");
    HttpURLConnection connectLoadSongFeatures = (HttpURLConnection) requestLoadSongFeatures.openConnection();
    ...
    HttpURLConnection connectLoadConnections = (HttpURLConnection) requestLoadConnections.openConnection();
    connectLoadConnections.connect();
    assertEquals(200, connectLoadConnections.getResponseCode());
    connectLoadConnections.disconnect();

    URL requestUser = new URL("http://localhost:" + Spark.port() + "/get-user?id=y9zwQW9ptlPURO6XtVoG");
    HttpURLConnection clientConnection = (HttpURLConnection) requestUser.openConnection();
    clientConnection.connect();
    assertEquals(200, clientConnection.getResponseCode());
    Moshi moshi = new Builder().build();
    GetUserSuccessResponse actualResponse = moshi.adapter(GetUserSuccessResponse.class)
    ...
    // Now we check that Song, Connections, and Historical Connections have been updated by our API calls
  ...
  public void testGetUser() throws IOException {
    URL requestURL = new URL("http://localhost:" + Spark.port() + "/get-user?id=TJWATWNITXLQCVcSroz1");
    ...
    GetUserSuccessResponse actualResponse = moshi.adapter(GetUserSuccessResponse.class)
        .fromJson(new Buffer().readFrom(clientConnection.getInputStream()));
    GetUserSuccessResponse mockResponse = new GetUserSuccessResponse("success",this.database.getUser("TJWATWNITXLQCVcSroz1"));
  ...
  public void testInvalidGetUser() throws IOException {
    ...
    assertEquals(200, clientConnection.getResponseCode());
    Moshi moshi = new Builder().build();
    ErrBadRequestResponse actualResponse = moshi.adapter(ErrBadRequestResponse.class)
        .fromJson(new Buffer().readFrom(clientConnection.getInputStream()));
  ...
  public void testGetAllUserIds() throws IOException {
    ...
    assertEquals(200, clientConnection.getResponseCode());
    Moshi moshi = new Builder().build();
    GetUserIdsSuccessResponse actualResponse = moshi.adapter(GetUserIdsSuccessResponse.class)
        .fromJson(new Buffer().readFrom(clientConnection.getInputStream()));
    GetUserIdsSuccessResponse mockResponse = new GetUserIdsSuccessResponse("success",this.database.getAllUserIds());
    assertEquals(mockResponse, actualResponse);
    clientConnection.disconnect();
  }

  /**
   * Testing that a load-song-features request returns the correct success response and updates
   * the current song of each user. We check if the original song (prior to calling load-song-features)
  ...
  public void testLoadSongFeatures() throws IOException {
    ...
    assertEquals(200, clientConnection.getResponseCode());
    Moshi moshi = new Builder().build();
    LoadSongFeaturesSuccessResponse actualResponse = moshi.adapter(LoadSongFeaturesSuccessResponse.class)
        .fromJson(new Buffer().readFrom(clientConnection.getInputStream()));
    LoadSongFeaturesSuccessResponse mockResponse = new LoadSongFeaturesSuccessResponse("success",this.database.getAllUserIds());
    assertEquals(mockResponse, actualResponse);
  ...
  public void testLoadConnections()  throws IOException {
    ...
    assertEquals(200, clientConnection.getResponseCode());
    Moshi moshi = new Builder().build();
    LoadConnectionsSuccessResponse actualResponse = moshi.adapter(LoadConnectionsSuccessResponse.class)
        .fromJson(new Buffer().readFrom(clientConnection.getInputStream()));
