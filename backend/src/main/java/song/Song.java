...
public class Song implements KdTreeNode, Cloneable {
  ...
  public boolean equals(Object o) {
    ...
    Song song = (Song) o;
    return this.dimension == song.dimension && Objects.equals(this.userId, song.userId)
        && this.title.equals(song.title) && this.id.equals(song.id) && this.artists.equals(song.artists)
